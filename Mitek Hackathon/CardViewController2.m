...
@implementation CardViewController2
...
-(void)presentNew
{
    ...
    postImageView *controller = [self.storyboard instantiateViewControllerWithIdentifier:@"postImageView2"];
